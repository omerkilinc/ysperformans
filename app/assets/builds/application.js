...
%o`, message, error2, detail);
  ...
  var form_controller_default = class extends Controller {
    ...
    connect() {
      if (this.hasFormTarget) {
        [...document.getElementsByClassName("field_with_errors")].forEach((element) => {
    ...
    reset() {
      [...document.getElementsByClassName("is-invalid")].forEach((e) => {
  ...
  // app/javascript/controllers/tomselect_controller.js
  var import_tom_select = __toESM(require_tom_select_complete());
  var tomselect_controller_default = class extends Controller {
    connect() {
  ...
  application.register("tomselect", tomselect_controller_default);
})();
